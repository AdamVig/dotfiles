...
# Documentation: https://github.com/ohmyzsh/ohmyzsh/blob/master/plugins/git/README.md
# List all aliases and functions in this file:
# rg -e '^alias (.+?)=.*$' -e '^function (.+?)\(.*$' --only-matching --replace='$1$2' zsh/git.zsh | sort
